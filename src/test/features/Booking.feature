Feature: Memilih destinasi tujuan penerbangan
  ...
  Scenario: User belum login memilih salahsatu destinasi tujuan
    ...
    Then user redirect ke halaman pilih penerbangan "http://localhost:3000/users/public/detailPenerbangan?airportIdFrom=0196a5d9-3478-7e72-90f3-4058115ba17c&airportIdTo=0196a5d9-347d-74e2-bb77-f8240d86c3c8&departureDate=2025-06-15"

  Scenario: User belum login memilih penerbangan
    Given user berada di halaman pilih penerbangan "http://localhost:3000/users/public/detailPenerbangan?airportIdFrom=0196a5d9-3478-7e72-90f3-4058115ba17c&airportIdTo=0196a5d9-347d-74e2-bb77-f8240d86c3c8&departureDate=2025-06-15"
  ...
  Scenario: User sudah login memilih penerbangan
    ...
    And user memasukkan no paspor/no ktp "0123456789123456" dengan xpath "//input[@placeholder='Masukkan No. KTP/Paspor']"

Feature: Memilih destinasi tujuan penerbangan
  ...
  Scenario: User memilih salahsatu destinasi tujuan
    Given user membuka halaman utama "http://localhost:3000/users/public/detailPenerbangan?airportIdFrom=0196a5d9-347e-7ff3-83ad-c83e2f2e1342&airportIdTo=0196a5d9-3478-7e72-90f3-4058115ba17c&departureDate=2025-06-15"
